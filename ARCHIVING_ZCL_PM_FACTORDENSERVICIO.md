...
| **Última Actualización** | 23-Marzo-2026 - Alineación de Alcance y Estado Consolidado |
...
**Estado consolidado de la implementación:**
- ✅ **Core SD archiving implementado:** triple gating, lectura híbrida BD + Archive para VBRK y VBRP
- ✅ **Correcciones críticas aplicadas:** `needs_archive()` robusto, exclusión SFAKN, alineación de infostructura KONV
- ✅ **Pricing histórico SD cubierto técnicamente:** existe enriquecimiento best-effort de KONV desde archive
- ⏸️ **Testing funcional pospuesto:** será ejecutado por el equipo funcional, fuera del alcance de este desarrollo
- ⏳ **Siguiente paso técnico pendiente:** ajustar el reporte consumidor ZPM_REP_FACTORDENSERVICIO para consumir la clase _ARC

**Interpretación de fase actual:**
- **Bitácora por fases internas:** Fase 2B completada y consolidada
- **Estado técnico real:** Fase 2C parcialmente materializada por el soporte de KONV, sin abrir alcance adicional a PM
- **Próxima fase activa:** Fase 5 - Ajuste Reporte Consumidor

**Impacto en el plan:**
- Se elimina como pendiente obligatoria cualquier referencia a PM_ORDER archive para este desarrollo
- Fase 3 deja de incluir VIAUFKS/AUFK y se reduce a ajustes opcionales de SD si negocio los requiere
- El testing funcional deja de ser prerequisito de desarrollo y queda documentado como actividad posterior del funcional

> **Nota de vigencia:** Las secciones históricas más abajo conservan el análisis original del trabajo. Si alguna línea antigua contradice este bloque, prevalece esta actualización del 23-Marzo-2026.
...
### **FASE 3: Ajustes SD Opcionales (DIFERIDA / NO BLOQUEANTE)**

**Objetivo:** Resolver únicamente ajustes adicionales de **SD** si aparecen hallazgos funcionales posteriores.

**Alcance confirmado:**
- PM_ORDER / VIAUFKS / AUFK **fuera de alcance de archiving**
- Los datos PM continúan en **BD** por decisión explícita del desarrollo
- El soporte de archivo se limita a la familia **SD_VBRK** y pricing relacionado de SD

**Líneas posibles de trabajo futuro (solo si negocio lo pide):**
- [ ] Ajustes finos de KONV si aparecen diferencias en pricing histórico SD
- [ ] Documentar limitaciones funcionales residuales de datos históricos
- [ ] Mejoras menores de performance o trazabilidad en lecturas SD archive

**Estado:** No bloquea la adopción actual. Puede permanecer diferida.

---

### **FASE 4: Optimización y Testing (PENDIENTE / EXTERNA EN PARTE)**
...
### **Media Prioridad (Estado Revisado)**

3. **¿Se requiere ajuste adicional de pricing histórico SD?**
   - Opción A: Mantener implementación actual con KONV best-effort
   - Opción B: Ajustar si funcional detecta diferencias en validación posterior
   - **DECISIÓN:** ⏳ Pendiente validación funcional posterior

4. **Testing funcional de usuario**
   - Responsable: área funcional
   - Estado: ⏸️ Pospuesto / fuera del alcance del desarrollo actual
   - **DECISIÓN:** No bloquea la siguiente entrega técnica

5. **Reporte consumidor**
   - Opción A: Modificar ZPM_REP_FACTORDENSERVICIO
   - Opción B: Crear copia _ARC
   - **DECISIÓN:** ⏳ Pendiente según criterio de transporte / riesgo funcional
...
### **Fase 2B - Estado Cierre ✅**
- [x] Implementación técnica SD completada
- [x] Correcciones críticas consolidadas (`needs_archive`, `SFAKN`, `KONV`)
- [ ] Testing funcional pendiente del área funcional (no bloqueante para desarrollo)

### **Fase 3 - Diferida / No Aplicable a PM ✅**
- [x] Alcance confirmado: no se implementará archiving para PM_ORDER
- [ ] Ajustes adicionales de SD solo si aparecen hallazgos posteriores
...
1. ✅ Archiving SD implementado en clase ZCL_PM_FACTORDENSERVICIO_ARC
2. ✅ Alcance confirmado: PM sigue por BD, sin archiving
3. ✅ Pricing histórico SD con soporte técnico best-effort
4. ⏳ Pendiente de desarrollo: ajuste del reporte consumidor ZPM_REP_FACTORDENSERVICIO
5. ⏸️ Testing funcional diferido al equipo funcional

**Siguiente paso recomendado:**
- Ajustar el reporte consumidor para exponer p_hist y consumir la clase _ARC
- Mantener sin cambios la lógica PM en BD
- Dejar el testing funcional como actividad posterior a la entrega técnica
...
**Fin de Documento • Versión 3.2 (Alcance SD Consolidado / Reporte Consumidor Pendiente) • 23-Marzo-2026**
